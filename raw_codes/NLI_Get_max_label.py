...
# MAGIC %run "./../../package_loader/call_transcript_NLP_BERT_libs_stg5_pl4_yujing.py" 
...
MODEL_NAME = "trained_sentiment_deberta-v3-large-zeroshot-v2_moderate_true_pf"
LABELS = ['This text has the positive sentiment', 
          'This text has the negative sentiment', 
          'This text has the neutral sentiment'
]
...
print(f"{col}: {currdf_spark.select('SENT_LABELS_FILT_MD').dtypes}")
...
columns_filt =(['ENTITY_ID', 'CALL_ID', 'VERSION_ID', 'DATE', 'CALL_NAME', 'COMPANY_NAME', 'LEN_FILT_MD', 'LEN_FILT_QA', 'FILT_MD', 'FILT_QA', 'SENT_LABELS_FILT_MD', 'SENT_LABELS_FILT_QA'] + 
...
array_type_cols = ["This text has the neutral sentiment_SCORE_FILT_MD",
                  "This text has the positive sentiment_SCORE_FILT_MD",
                  "This text has the negative sentiment_SCORE_FILT_MD",
                  "This text has the negative sentiment_SCORE_FILT_QA",
                  "This text has the positive sentiment_SCORE_FILT_QA",
                  "This text has the neutral sentiment_SCORE_FILT_QA",
                  ]                
...
currdf_spark.select('SENT_LABELS_FILT_MD', 'SENT_LABELS_FILT_QA', 'DATE', "NLI_SENT_LABELS_FILT_QA").limit(10).show()
...
tablename_curr = "YUJING_ECALL_NLIV3_SENTIMENT_DEV_1" #'YUJING_MASS_SENTIMENT_NLI_OPTIM_TEST_2'
