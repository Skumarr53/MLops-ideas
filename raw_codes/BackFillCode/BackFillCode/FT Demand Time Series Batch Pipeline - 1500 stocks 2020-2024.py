...
# MAGIC
# MAGIC Reads from: QUANT.SANTHOSH_MASS_FT_NLI_DEMAND_DEV_1
# MAGIC
# MAGIC Writes to: QUANT.SANTHOSH_MASS_FT_DEMAND_TS_DEV_1
# MAGIC
...
tsQuery= ("SELECT * "
    f"FROM  EDS_PROD.QUANT.{DEV_NAME}_MASS_FT_NLI_DEMAND_DEV_1 "
...
df_rel_cover_all.CATEGORY[2]

# COMMAND ----------

df_rel_cover_all = df_rel_cover_all[[
    "DATE_ROLLING",
    "COMPANY_COUNT",
    "INCREASED_CONSUMPTION_COVERRATE_FILT_MD",
...
tablename_curr = f'{DEV_NAME}_MASS_FT_DEMAND_TS_DEV_1'
