...
# sp_df.YEAR_MONTH.value_counts().sort_index(ascending=True)
...
mf_df[mf_df.YEAR_MONTH == '2024-01'].factset_entity_id.value_counts().sort_index(ascending=True)

# COMMAND ----------

mf_df[mf_df.YEAR_MONTH == '2024-08'].factset_entity_id.value_counts().sort_index(ascending=True)
#  .YEAR_MONTH.value_counts().sort_index(ascending=True)

# COMMAND ----------

mf_df[(mf_df.YEAR_MONTH == '2024-08') & (mf_df.factset_entity_id == '000BG2-E')]
...
tablename_curr = f'{dev_name}_MASS_FT_NLI_DEMAND_DEV_1'
