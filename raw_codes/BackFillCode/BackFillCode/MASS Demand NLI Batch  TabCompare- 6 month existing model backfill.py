...
# Step 7: Data Transformation Using Sparka DataFrame API
...
LABELS_MAPPING = {
    ...
    "This text is about reduced consumer's spending patterns": "CONSUMER_REDUCED_SPENDING_PATTERNS"
}
...
columns_order = ['ENTITY_ID', 'CALL_ID', 'VERSION_ID', 'DATE', 'CALL_NAME', 'COMPANY_NAME', 
      #  'UPLOAD_DT_UTC', 'PARSED_DATETIME_EASTERN_TZ', 
       'LEN_FILT_MD', 'LEN_FILT_QA', 'FILT_MD', 'FILT_QA', 'SENT_LABELS_FILT_MD', 'SENT_LABELS_FILT_QA',
       'CONSUMER_STRENGTH_COUNT_FILT_MD', 'CONSUMER_STRENGTH_REL_FILT_MD',
       ...
       'CONSUMER_REDUCED_SPENDING_PATTERNS_COUNT_FILT_MD',
       'CONSUMER_REDUCED_SPENDING_PATTERNS_REL_FILT_MD',
       'CONSUMER_REDUCED_SPENDING_PATTERNS_SCORE_FILT_MD',
       'CONSUMER_REDUCED_SPENDING_PATTERNS_TOTAL_FILT_MD',
       ...
       'CONSUMER_REDUCED_SPENDING_PATTERNS_COUNT_FILT_QA',
       'CONSUMER_REDUCED_SPENDING_PATTERNS_REL_FILT_QA',
       'CONSUMER_REDUCED_SPENDING_PATTERNS_SCORE_FILT_QA',
       'CONSUMER_REDUCED_SPENDING_PATTERNS_TOTAL_FILT_QA',
       'CONSUMER_REDUCED_SPENDING_PATTERNS_EXTRACT_FILT_QA'
       ]
...
# COMMAND ----------
 ...
 f'{DEV_NAME}_MASS_FT_NLI_DEMAND_DEV_6M_EXISTING_MODEL'

# COMMAND ----------

tablename_curr = f'{DEV_NAME}_MASS_FT_NLI_DEMAND_DEV_6M_EXISTING_MODEL'
