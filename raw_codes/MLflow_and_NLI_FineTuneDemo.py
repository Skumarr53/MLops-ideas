...
def run_finetune(base_model_path: str,train_file: str, output_dir: str,validation_file: str: None, param_dict: Dict[str, Any] = {}) -> Tuple[AutoModelForSequenceClassification, Dict[str, float]]:
...
# Assuming ModelArguments and DataTrainingArguments are defined elsewhere
# from your_module import ModelArguments, DataTrainingArguments, run_glue
...
def run_finetune(
    ...
    Args:
        ...
        param_dict (Optional[Dict[str, Any]], optional): Dictionary of additional parameters. Defaults to None.
