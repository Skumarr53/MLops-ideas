...
maxDateNewQuery = pd.to_datetime("03-01-2021").strftime('%Y-%m-%d')
...
# COMMAND ----------
  ...
  columns_order = ['ENTITY_ID', 'CALL_ID', 'VERSION_ID', 'DATE', 'CALL_NAME',
       ...
       'CONSUMER_WEAKNESS_SCORE_FILT_MD', 'CONSUMER_WEAKNESS_TOTAL_FILT_MD','CONSUMER_WEAKNESS_EXTRACT_FILT_MD',
       'CONSUMER_SPENDING_PATTERNS_COUNT_FILT_MD',
       'CONSUMER_SPENDING_PATTERNS_REL_FILT_MD',
       'CONSUMER_SPENDING_PATTERNS_SCORE_FILT_MD',
       'CONSUMER_SPENDING_PATTERNS_TOTAL_FILT_MD','CONSUMER_SPENDING_PATTERNS_EXTRACT_FILT_MD',
       'CONSUMER_STRENGTH_COUNT_FILT_QA', 'CONSUMER_STRENGTH_REL_FILT_QA',
       'CONSUMER_STRENGTH_SCORE_FILT_QA', 'CONSUMER_STRENGTH_TOTAL_FILT_QA','CONSUMER_STRENGTH_EXTRACT_FILT_QA',
       'CONSUMER_WEAKNESS_COUNT_FILT_QA', 'CONSUMER_WEAKNESS_REL_FILT_QA',
       'CONSUMER_WEAKNESS_SCORE_FILT_QA', 'CONSUMER_WEAKNESS_TOTAL_FILT_QA','CONSUMER_WEAKNESS_EXTRACT_FILT_QA',
       ...
       'CONSUMER_SPENDING_PATTERNS_EXTRACT_FILT_QA']
...
tablename_curr = 'YUJING_MASS_NLI_TEST_DEV_2'
